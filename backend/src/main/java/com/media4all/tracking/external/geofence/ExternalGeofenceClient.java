...
@Component
public class ExternalGeofenceClient implements ExternalGeofenceGateway {

    private final WebClient webClient;
    private final ExternalApiRetryPolicy retryPolicy;

    public ExternalGeofenceClient(
                ...
                ExternalGeofenceResponse response = webClient.get()
                        ...
                        .exchangeToMono(clientResponse -> {
                            ...
                            if (status.is2xxSuccessful()) {
                                return clientResponse.bodyToMono(ExternalGeofenceResponse.class);
                            }
