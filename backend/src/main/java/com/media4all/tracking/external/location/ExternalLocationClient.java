...
@Component
public class ExternalLocationClient implements ExternalLocationGateway {

    private final WebClient webClient;
    private final ExternalApiRetryPolicy retryPolicy;

    public ExternalLocationClient(
                ...
                ExternalLocationResponse response = webClient.get()
                        ...
                        .exchangeToMono(clientResponse -> {
                            ...
                            if (status.is2xxSuccessful()) {
                                return clientResponse.bodyToMono(ExternalLocationResponse.class);
                            }
